...
If you maintain local crystallographic mirrors for search-match workflows, use
the standalone `CIF_index` / `Structure_index` database-entry repository and see
the repo guide at `docs/local_database_setup.md`. The older recovery notes are
also available in the documentation: https://cedergrouphub.github.io/dara/local_database_recovery.html
