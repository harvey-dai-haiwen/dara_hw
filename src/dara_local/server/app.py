...
from dara_local.server.setting import get_dara_server_settings
from dara_local.server.worker import worker_process

# Import the extension to register the new /api/search endpoint
from dara_local.server import api_router_extension  # noqa: F401
